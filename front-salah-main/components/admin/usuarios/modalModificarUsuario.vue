          ...
          <div class="fields-grid">
            ...
            <div class="field">
              ...
              <div class="field-control">
                ...
                <InputText id="contra" name="contra" :type="showPassword ? 'text' : 'password'" v-model="initialValues.contra" placeholder="Opcional" class="salah-input with-action" />
            ...
            <div class="field field-wide">
              <label for="confirmarContra">Confirmar nueva contrasena</label>
              <div class="field-control">
                <svg viewBox="0 0 24 24" class="field-icon">
                  <path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1Z" />
                  <path d="m9 12 2 2 4-4" />
                </svg>
                <InputText id="confirmarContra" name="confirmarContra" :type="showConfirmPassword ? 'text' : 'password'" v-model="initialValues.confirmarContra" placeholder="Confirmar solo si cambia la contrasena" class="salah-input with-action" />
        ...
        <section class="form-card photo-card">
          ...
          >
            ...
            <span class="photo-copy">
              <strong>{{ src ? 'Fotografia cargada' : 'Subir fotografia' }}</strong>
              <small>Arrastra una imagen o haz clic para cambiarla</small>
            </span>
          </button>
...
onMounted(async () => {
  try {
    ...
    initialValues.contra = ''
    initialValues.confirmarContra = ''
    initialValues.foto = null
    src.value = resValue.foto && resValue.foto !== 'N/A' ? resValue.foto : ''
...
const getSchema = () => z.object({
  ...
  estado: z.string().min(1, { message: 'Estado requerido.' }),
  foto: z
    .instanceof(File)
    .nullable()
