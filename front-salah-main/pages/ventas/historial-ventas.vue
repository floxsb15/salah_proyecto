  ...
  <div class="flex flex-col gap-4">
    <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
      <div>
        ...
        <p class="text-sm text-gray-500">Ventas registradas por el vendedor actual.</p>
      </div>
    ...
    <div class="grid grid-cols-1 gap-3 md:grid-cols-3">
      ...
      <div class="rounded-lg border border-gray-200 bg-white p-4">
        ...
        <p class="truncate text-lg font-semibold text-gray-900">{{ nombreVendedor }}</p>
      </div>
    </div>
    ...
    >
      <template #empty>
        <p class="p-4 text-center">No hay ventas registradas para este vendedor.</p>
      </template>
...
const nombreVendedor = ref('Usuario');
...
async function obtenerHistorial() {
  ...
  try {
    ...
    nombreVendedor.value = parsedUser?.nombre || 'Usuario';
